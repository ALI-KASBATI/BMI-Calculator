...
function printBMIResult(BMIInfo){
    ...
    let bmiCategory;
    if(BMIInfo.BMI < 18.5){
        bmiCategory = "Underweight (You are supposed to gain weight to become normal)";
    } else if(BMIInfo.BMI >= 18.5 && BMIInfo.BMI <= 24.9){
        bmiCategory = "Normal Weight (Perfectly Fit)";
    } else if(BMIInfo.BMI >= 25 && BMIInfo.BMI <= 29.9){
        bmiCategory = "Overweight (You need to lose Weight)";
    } else {
        bmiCategory = "Obesity (You need to lose Weight)";
    }
